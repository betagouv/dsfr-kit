...
- [ ] T049 [P] Add prerequisites section to README (Node.js 22+, pnpm 10+, Python 3.12+, uv, just)
...
- [ ] T055 Clean up test packages (`packages/test-lib/`, `packages/python-test/`) if they were only for validation

...
Official DSFR components implemented as framework-agnostic **Web Components** using [Lit](https://lit.dev/).
...
```bash
pnpm add @dsfr-kit/web-components
```
...
```html
<script type="module" src="https://unpkg.com/@dsfr-kit/web-components/dist/dsfr-web-components.es.js"></script>
...
1. Browse to `packages/web-components/src/components`.
